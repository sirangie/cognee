...
class DataPoint(BaseModel):
    ...
    @classmethod
    def get_embeddable_data(self, data_point: "DataPoint") -> Any | None:
        """
    ...
    @classmethod
    def get_embeddable_properties(self, data_point: "DataPoint") -> list[Any | None]:
        """
    ...
    @classmethod
    def get_embeddable_property_names(self, data_point: "DataPoint") -> list[str]:
        """
